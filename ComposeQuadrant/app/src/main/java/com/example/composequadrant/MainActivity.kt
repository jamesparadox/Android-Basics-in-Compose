...
fun QuadrantGrid(modifier: Modifier = Modifier){
    Column(Modifier.fillMaxWidth()){
        Row(Modifier.weight(1f)){
            Quadrant(
                title = stringResource(R.string.title_quadrant_1),
                description = stringResource(R.string.description_quadrant_1),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(R.string.title_quadrant_2),
        ...
        Row(Modifier.weight(1f)){
            Quadrant(
                title = stringResource(R.string.title_quadrant_3),
                description = stringResource(R.string.description_quadrant_3),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            Quadrant(
                title = stringResource(R.string.title_quadrant_4),
